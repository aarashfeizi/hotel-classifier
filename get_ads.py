...
def main():
    ...
    parser.add_argument('-jp', '--json_path', default='../../dataset/ad-data/')
    parser.add_argument('-fn', '--file_name', default='sample_ads_october_2019')
    ...
    ads = json.load(open(os.path.join(json_path, file_name + '.json')))
